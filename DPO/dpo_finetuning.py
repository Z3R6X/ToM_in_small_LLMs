...
class ScriptArguments:
    ...
    max_steps: Optional[int] = field(default=8500, metadata={"help": "max number of training steps"})
    logging_steps: Optional[int] = field(default=10, metadata={"help": "the logging frequency"})
    save_steps: Optional[int] = field(default=250, metadata={"help": "the saving frequency"})
    eval_steps: Optional[int] = field(default=250, metadata={"help": "the evaluation frequency"})

    output_dir: Optional[str] = field(default="data/DPO/DPO_FT", metadata={"help": "the output directory"})
...
def get_stack_exchange_paired(
    ...
    def return_prompt_and_responses(samples) -> Dict[str, str]:
        return {
            "prompt": ["Answer the following question in context:\n\nQuestion: " + question + " Answer: " for question in samples["prompt"]],
...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(
        ...
        run_name="GPT4All_DPO_FT" + "_" + time_id,
    )
