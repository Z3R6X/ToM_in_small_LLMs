...
parser.add_argument('--model', default='nomic-ai/gpt4all-j', type=str)
parser.add_argument('--revision', default='v1.3-groovy', type=str)
...
def main():
    ...
    output_dict = {
        'model': args.model + ' ' + args.revision,
    ...
    for scenario in scenarios:
        ...
        for i in range(num_rep):
            ...
            base_prompt = 'Scenario: ' + scenario['context'] + ' Question: ' + scenario['question'] + ' Answer: '
    ...
    with open(os.path.join('ToM_Eval_GPT4All', f'tom_output_{info_string}.json'), 'w') as outfile:
